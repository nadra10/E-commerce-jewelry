  ...
  return (
    ...
    >
      <Flex
        ...
        bgSize='cover'
        backgroundImage={{
          base: `url(https://plus.unsplash.com/premium_photo-1673285096696-370fb8b19f33?auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1yZWxhdGVkfDh8fHxlbnwwfHx8fHw%3D&w=800)`,
          md: `url(https://plus.unsplash.com/premium_photo-1673285096696-370fb8b19f33?auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1yZWxhdGVkfDh8fHxlbnwwfHx8fHw%3D&w=800)`,
        }}
      >
        <Heading
          color='brand.100'
      ...
      <Stack minHeight='100vh' mx='auto' align='center' as='section'>
        <Box direction='row' pt={6} mx='auto'>
          <Button
            {...buttonStyles}
            to='/products/Rings'
            color={isActive('/products/Rings') ? 'brand.4001' : 'brand.500'}
          >
            Rings
          </Button>
          /
          <Button
            ...
            color={isActive('/products/Earrings') ? 'brand.4001' : 'brand.500'}
          >
            Earrings
          </Button>
          /
